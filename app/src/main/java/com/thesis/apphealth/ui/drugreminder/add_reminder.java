...
public class add_reminder extends Fragment {

    private AddReminderViewModel mViewModel;

    public static add_reminder newInstance() {
        return new add_reminder();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AddReminderViewModel.class);
